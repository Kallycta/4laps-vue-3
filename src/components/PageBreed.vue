...
<template>
  <div class="community-expert__main-banner">
    <img :src="`${state.banner ? state.banner : 'https://expopk.ru/upload/iblock/51b/51b022afea429ec741eddb3050e51fdf.jpg'}`" alt="picture-animal`" />
  </div>
  ...
  <div class="video-and-articles-container">
    <div v-for="(item) in  state.videoAndArticles" v-bind:key="item.ID" @click="linkToArticlesPage(item.ID)" class="video-and-articles-element">
      <div class="video-and-articles-element__img">
        <img :src="`${item.PREVIEW_PICTURE ? item.PREVIEW_PICTURE : 'https://expopk.ru/upload/iblock/51b/51b022afea429ec741eddb3050e51fdf.jpg'}`" alt="picture-animal" />
      </div>
